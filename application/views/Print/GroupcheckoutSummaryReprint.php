...
<div class="col-sm-12">
  <div class="the-box F_ram">
     ...
     <div id="printing">
		...
		<thead>
					<tr>
					 ...
					 <img style="width:80%;margin-left:30px;" src="<?php echo scs_url . $logo; ?>" />
					</th>
		...
		<table style="border-right:1px solid #000;border-left:1px solid #000;border-bottom:1px solid #000;width:100%">
    			<tbody>
				  ...
				  <tr>
					...
					<td style="border-bottom:1px solid #000;width:30%"> <b>&nbsp;Room &nbsp;&nbsp;&nbsp;: </b>&nbsp;  <?php 
    ...
    <tbody>
		...
		$dayCount = $interval->days . " Days";
		// If start date and end date are the same, set day count to 1
		if ($begin == $end) {
			$dayCount = "1 Day";
		} 
		...
		$TotalAmount = $RoomRentCumulative + $CGSTCumulative +  $SGSTCumulative + $FoodCumulative -$advanceamount ;
        ?>
	...
	<?php if($advanceamount !=0) { ?>
		...
		<!-- <td style="text-align:center;padding-left:10px;border-right:1px solid #000;width:50%;"><?php echo $creditno; ?></td> -->
            ...
            <td style="text-align:right;padding-right:10px;border-right:1px solid #000;width:50%;"><?php echo "-";?><?php echo number_format($advanceamount, 2); ?></td>
        </tr>
	<?php } ?>
        <!-- <tr> -->
		<!-- <td style="text-align:left;padding-left:10px;border-right:1px solid #000;width:50%;"></td> -->
