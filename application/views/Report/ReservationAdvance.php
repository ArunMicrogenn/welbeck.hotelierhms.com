...
$this->pweb->Cheader('Report','Reservation AdvanceReport');
$this->pfrm->FrmHead6('Report /Reservation Advance Report',$F_Class."/".$F_Ctrl,$F_Class."/".$F_Ctrl."_View");
  ...
  <div class="the-box D_IS" ></div>
    ...
    <div id="printing" class="col-sm-12">
        ...
        <table class="table table-bordered table-hover"  >  
		    <div>
				<h4 class="text-center">Reservation Advance Report  <?php echo date('d-m-Y', strtotime($_POST['frmdate'])); ?> To <?php echo date('d-m-Y', strtotime($_POST['todate'])); ?><h4>
		    </div>           
		   <tbody>
		    <?php 
			 $i=1;	
             ...
             $qry="exec  pendingAdvance__report'".$fromdate."', '".$todate."'";
			 ...
			 $advance= $exec->num_rows();
			  if($advance !=0)
			  {
                ...
                echo '<td style="text-align: center;">Reserved By</td>';
        ...
        $("#exporttable").click(function(e)
		{
          ...
          if(table && table.length)
		  {
            $(table).table2excel({
              ...
              filename: "ReservationAdvance__Report" + new Date().toISOString().replace(/[\-\:\.]/g, "") + ".xls",
              fileext: ".xls",
              exclude_img: true,
              exclude_links: true,
              exclude_inputs: true,
        ...
        $("body").on("click", "#exportpdf", function () {
            html2canvas($('#printing')[0], {
                onrendered: function (canvas) {
                    ...
                    pdfMake.createPdf(docDefinition).download("ReservationAdvance__Report.pdf");
                }
            });
        });
	</SCRIPT>