		 ...
		 foreach($Res as $row)
			{
			   ...
			   <?php
               echo   '<td>
					  <a class="btn btn-warning btn-xs" href="'.scs_index.$F_Class."/".$F_Ctrl."/".$row['MarketSegment_Id'].'/UPDATE"   >
                 ...
                 /*| 
					   <a class="btn btn-danger btn-xs" href="'.scs_index.$F_Class."/".$F_Ctrl."/".$row['MarketSegment_Id'].'/DELETE"   >
