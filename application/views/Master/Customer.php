    ...
    <fieldset>
      ...
      <table class="FrmTable T-8" >
		...
		<td align="right" class="F_val">FirstName<label style="Color:red">*</label></td>
          ...
          <td align="right" class="F_val">Title</td>
		...
		<tr>
	     ...
	     <tr id="dataTable1">
		  ...
		  <input type="hidden" placeholder="Company_Id" id="Company_Id" name="Company_Id" value="<?php echo @$Company_id; ?>" class="scs-ctrl" />
        ...
        <tr>
          ...
          <td align="left"><input maxlength="6"  type="text" placeholder="PINCode" id="PINCode" name="PINCode" value="<?php echo @$Homepincode; ?>" class="scs-ctrl " />
