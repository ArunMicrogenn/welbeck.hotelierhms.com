		 ...
		 foreach($Res as $row)
			{
               ...
               echo  '<td>
                 ...
                 /*| 
					   <a class="btn btn-danger btn-xs" href="'.scs_index.$F_Class."/".$F_Ctrl."/".$row['BusinessSource_Id'].'/DELETE"   >
