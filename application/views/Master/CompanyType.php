...
<div class="col-sm-12">
  <div class="the-box F_ram">
    <fieldset>
    <input type="hidden" name="idv" value="<?php echo @$CompanyType_Id; ?>" >
      <table class="FrmTable T-4" >
        <tr>
          <td align="right" class="F_val">CompanyType</td>
          <td align="left"><input type="text" placeholder="CompanyType" id="CompanyType" name="CompanyType" value="<?php echo @$CompanyType; ?>" class="scs-ctrl" />
            <div class="CompanyType" ></div></td>
        </tr>
