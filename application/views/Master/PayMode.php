...
<div class="col-sm-12">
  <div class="the-box F_ram">
    <fieldset>
    <input type="hidden" name="idv" value="<?php echo @$PayMode_Id; ?>" >
      <table class="FrmTable T-4" >
        <tr>
          <td align="right" class="F_val">PayMode</td>
          <td align="left"><input type="text" placeholder="PayMode" id="PayMode" name="PayMode" value="<?php echo @$PayMode; ?>" class="scs-ctrl" />
