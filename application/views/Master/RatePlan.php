  ...
  <div class="the-box F_ram">
    <fieldset>
      ...
      <table class="FrmTable T-12" >
        <tr>
          <td align="left" class="F_val">RoomType</td>
		...
		<td align="left" class="F_val">Is Ota</td>
<td align="left">
  <select id="isota" name="isota" class="scs-ctrl">
  ...
  <div class="isota"></div>
		...
		<tr class="ota_extra_fields">
    <td align="left" class="F_val">RateCode</td>
    <td align="left">
        <input type="text" id="Otaratecode" name="Otaratecode" value="<?php echo @$Otaratecode; ?>" class="scs-ctrl" />
        <div class="Otaratecode"></div>
    </td>
    <td align="right" class="F_val">PaymentPolicy Code</td>
    <td align="left">
        <input type="text" id="Otapaymentpolicycode" name="Otapaymentpolicycode" value="<?php echo @$Otapaymentpolicycode; ?>" class="scs-ctrl" />
        <div class="Otapaymentpolicycode"></div>
    </td>
</tr>
<tr class="ota_extra_fields">
    <td align="left" class="F_val">Cancel Code</td>
    <td align="left">
        <input type="text" id="Otacancelcode" name="Otacancelcode" value="<?php echo @$Otacancelcode; ?>" class="scs-ctrl" />
        <div class="Otacancelcode"></div>
    </td>
</tr>
        ...
        <td valign="top">
        <!---- Padmanaban Sir Says Hiden --->
          <input onClick="val_()" type="hidden" class="chk" name="Mon" id="Mon" <?php if(@$Mon==1) { echo 'checked'; } ?> ><!-- Mon  -->
          <input  onClick="val_()" type="hidden" class="chk" name="Tue" id="Tue" <?php if(@$Tue==1) { echo 'checked'; } ?>><!-- Tue -->
          <input  onClick="val_()" type="hidden" class="chk" name="Wed" id="Wed" <?php if(@$Wed==1) { echo 'checked'; } ?>><!-- Wed -->
          
          <input  onClick="val_()" type="hidden" class="chk" name="Thu" id="Thu" <?php if(@$Thu==1) { echo 'checked'; } ?>><!-- Thu -->
          <input  onClick="val_()" type="hidden" class="chk" name="Fri" id="Fri" <?php if(@$Fri==1) { echo 'checked'; } ?>><!-- Fri  -->
          <input  onClick="val_()" type="hidden" class="chk"  name="Sat" id="Sat" <?php if(@$Sat==1) { echo 'checked'; } ?>><!-- Sat -->
          <input  onClick="val_()" type="hidden" class="chk"  name="Sun" id="Sun" <?php if(@$Sun==1) { echo 'checked'; } ?>><!-- Sun -->
          
          </td>
        </tr>
        <tr>
          <td > <input type="hidden"   id="TariffIncOfPlan" name="TariffIncOfPlan"   <?php if(@$TariffIncOfPlan==1) { echo 'checked'; } ?>   /><!-- Tariff Inclusive of Plan --></td>
        </tr> <td></td>
        <tr>
          <td ><input type="hidden"   id="PlanIncTax" name="PlanIncTax"   <?php if(@$PlanIncTax==1) { echo 'checked'; } ?>   /><!-- Plan Inclusive Tax ---></td> <td></td>
        </tr>
      ...
      <table width="100%" class="mytable" style="margin-top:20px">
        <thead>
          <tr>
            ...
            <th  ><div align="center">Quarter Triple</div></th>
            <th  ><div align="center">Adult Rate</div></th>
            <th  ><div align="center">Child Rate</div></th>
		  ...
		  ?>
               ...
               <td><input type="text" num=1 name="AdultPlanAmt" id="AdultPlanAmt" value="<?php echo @$AdultPlanAmt; ?>"    class="f-ctrl " style="border:2px solid #E4E4E4" /></td>
                ...
                <td><input type="text" num=1 name="ChildPlanAmt" id="ChildPlanAmt" value="<?php echo @$ChildPlanAmt; ?>"    class="f-ctrl" style="border:2px solid #E4E4E4" /></td>
                 ...
                 <td><input type="hidden" num=1 name="WeekSingle" id="WeekSingle" value="<?php echo @$WeekSingle; ?>"    class="f-ctrl rmm rmchk" style="border:2px solid #E4E4E4" /></td>
                 
                  <td><input type="hidden" num=1 name="WeekDoubles" id="WeekDoubles" value="<?php echo @$WeekDoubles; ?>"    class="f-ctrl rmm rmchk" style="border:2px solid #E4E4E4" /></td>
                  
                   <td><input type="hidden" num=1 name="WeekTriple" id="WeekTriple" value="<?php echo @$WeekTriple; ?>"    class="f-ctrl rmm rmchk" style="border:2px solid #E4E4E4" /></td>
                   
                    <td><input type="hidden" num=1 name="WeekQuadruple" id="WeekQuadruple" value="<?php echo @$WeekQuadruple; ?>"    class="f-ctrl rmm rmchk" style="border:2px solid #E4E4E4" /></td>
 ...
 Add</a> </td>
	  ...
	  <!-- <table style=" padding:5px " class="mytable">
	  <tr>
          <td align="left" class="F_val">RateCode</td>
          <td align="left">
		  <input type="text"   id="Otaratecode" name="Otaratecode" value="<?php echo @$Otaratecode; ?>" class="scs-ctrl" />

            <div class="Otaratecode" ></div></td>
          <td align="right" class="F_val">PaymentPolicy Code</td>
          <td align="left">
		  <input type="text"   id="Otapaymentpolicycode" name="Otapaymentpolicycode" value="<?php echo @$Otapaymentpolicycode; ?>" class="scs-ctrl" />
            <div class="Otapaymentpolicycode" ></div></td>
		  ...
		  <input type="text"   id="Otacancelcode" name="Otacancelcode" value="<?php echo @$Otacancelcode; ?>" class="scs-ctrl" />
            ...
            <div class="Otacancelcode" ></div></td>
          <td align="right" class="F_val">Is Ota</td>
          <td align="left">
		  <select type="text"   id="isota" name="isota"   class="scs-ctrl" >
              <option value="1" > Yes </option>
              <option value="2" > No</option>
		
            </select>
            <div class="isota" ></div></td>
...
$(document).ready(function () {
    // Set the dropdown to saved value (if any)
    $('#isota').val('<?php echo @$isota; ?>');

    toggleOtaFields(); 

    // Toggle fields on change
    $('#isota').on('change', function () {
        toggleOtaFields();
    });
});

// Function to show/hide OTA-specific fields
function toggleOtaFields() {
    var isOtaVal = $('#isota').val();
    if (isOtaVal === '1') {
        $('.ota_extra_fields').show();
    } else {
        $('.ota_extra_fields').hide();
        $('#Otaratecode, #Otapaymentpolicycode, #Otacancelcode').val('');
    }
}
</script>
