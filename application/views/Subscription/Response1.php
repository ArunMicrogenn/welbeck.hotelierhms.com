...
$this->pfrm->FrmHead7('Subscription / Response',$F_Class."/".$F_Ctrl,$F_Class."/".$F_Ctrl."_View");
            ...
            <div class="the-box F_ram">
                <fieldset>
                    <table class="FrmTable T-4" >
                        ...
                        <tr>
                            <td align="left" class="F_val">Your Transaction receipt we sent to your email.</td>
                            <td align="left"></td>
                        </tr>
                        <tr>
                            <td align="left" class="F_val">If you Need Bill Kindly Contact Accounts Dept.</td>
                            <td align="left"></td>
                        </tr>
                    </table>
                </fieldset>
