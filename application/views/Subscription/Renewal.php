...
<div class="col-sm-12">
  <div class="the-box F_ram">
    <fieldset>
	<form method="POST" action="<?php echo scs_index ?>Subscription/RenewalPaymentGateway">
      ...
      <table class="FrmTable T-4" >
		...
		<tr>
         ...
         <tr>
          ...
          <td align="left"> 
		  <select onchange="Subscriptionselection(this.value)" name="SubscriptionType" id="SubscriptionType" class="scs-ctrl" >
        ...
        <tr>
          <td align="right">&nbsp;</td>
          <td align="left">			
			<input type="submit"  class="btn btn-success btn-sm" id="PayNow" name="PayNow" value="Pay Now"   />
            &nbsp;
            <a href="<?php echo scs_index ?>" type="button"  class="btn btn-success btn-sm" id="PayNow" name="PayNow" value="Cancel">Cancel</a></td>
        </tr>
      </table>
    </fieldset>
  </div>
