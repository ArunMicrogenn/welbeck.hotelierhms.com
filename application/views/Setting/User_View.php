...
$this->pweb->Cheader('Master','User');
$this->pfrm->FrmHead1('Master / User',$F_Class."/".$F_Ctrl,$F_Class."/".$F_Ctrl."_View");
		 ...
		 foreach($Res as $row)
			{
			   ...
			   <?php					   		 
               echo  '<td>
					  <a class="btn btn-warning btn-xs" href="'.scs_index.$F_Class."/".$F_Ctrl."/".$row['User_id'].'/UPDATE"   >
