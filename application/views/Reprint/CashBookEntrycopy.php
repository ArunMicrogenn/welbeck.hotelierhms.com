    ...
    <fieldset>
     <div id="printing">
		...
		<tr id="dataTable1">
		 ...
		 <?php  $sql = "select * from trans_cash_book where Dailyid=1";
		...
		<tr id="dataTable1" style="width:100%;border:0px;">		  	   
		    <td style="border:0px;border-left:solid #CDCDCD  1px;width:50%"><p></P></td>
			
		</tr>
		<tr id="dataTable1" style="width:100%;border:0px;">		  	   
		    <td style="border:0px;border:solid #CDCDCD  1px;width:20%;">Head Name</td>
			<td style="border:0px;border:solid #CDCDCD  1px;">Head Name</td>
			<td style="border:0px;border:solid #CDCDCD  1px;">Head Name</td>
			<td style="border:0px;border:solid #CDCDCD  1px;">Head Name</td>
		...
		<tr id="dataTable1" style="width:100%;border:0px;">		  	   
		    <td style="border:0px;border-left:solid #CDCDCD  1px;width:50%"><p> <b>&nbsp;&nbsp;Narration :</b> </P></td>
