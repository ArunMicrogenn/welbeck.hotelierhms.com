 ...
 $currentDate; ?>
  ...
  <div class="the-box D_IS" ></div>
	 ...
	 $todate = date('Y-m-d', strtotime($_POST['todate']));
		...
		<div class="mt-4">
		<h4 class="text-center">Advance Receipt  <?php echo date('d-m-Y', strtotime($_POST['frmdate'])); ?> To <?php echo date('d-m-Y', strtotime($_POST['todate'])); ?><h4>
		    </div>        
		   <tbody>
		    <?php 
			 $i=1;
			 ...
			 inner join Mas_Room rm on rm.Room_Id=re.roomid WHERE ReceiptType='C' and re.rptdate between '".$fromdate."' and '".$todate."'    Order by Receiptid desc";
