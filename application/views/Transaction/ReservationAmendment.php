...
$this->pweb->Cheader('Transaction','Reservation Amendment');
$this->pfrm->FrmHead2('Transaction/ Reservation Amendment',$F_Class."/".$F_Ctrl,$F_Class."/".$F_Ctrl."_View");
...
<div class="col-sm-12">
    ...
    <fieldset>
      ...
      <table class="FrmTable T-3" >
        <tr>
          ...
          <td align="left"> <input type="text"  name="Resnumber" id="Resnumber" onclick="GetReservation()" value="" ></td>
	   ...
	   <td><input type="text"  num=1 Placeholder="+91-19865999" name="mobile" id="mobile"  class="f-ctrl rmm" ></td>
	   <td style="text-align: right;">Name<td>
	   <td><input type="text" id="Name" name="Name" class="f-ctrl rmm"> <td>
	   <td style="text-align: right;">Email<td>
	   <td><input type="text" id="Email" name="Email" class="f-ctrl rmm"> <td>
	   <td style="text-align: right;">City<td>
	   <td><input type="text" id="City" name="City" class="f-ctrl rmm"> <td>
	   </tr>
	   </table>
	   <br>
	   <table class="FrmTable T-10" >
  ...
  <div id="Resnumber" class="Resnumber" style="display:none;width:450px" title="Number">
</div>
</div>
<?php
$this->pfrm->FrmFoot();
...
{   var a=1;
	$.ajax({
		type:"POST",
		url:"<?php echo scs_index;?>Transaction/GetResNo/",
