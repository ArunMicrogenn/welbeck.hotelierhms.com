			 ...
			 <div class="box">
			    <table class="FrmTable">
				 ...
				 <tr>
				  ...
				  <tr>
					<td>
						<select name="IDPROOFSELECT" id="IDPROOFSELECT">
					...
					<td>
						<input type="text" name="proofnumber" id="proofnumber"  readonly>
					</td>
				  </tr>  
				</table>
			 </div>
 ...
 <form method="POST" enctype="multipart/form-data" id="formcheckin">
  ...
  <tr>
	...
	{ $dateDiff ='1';}
	 ...
	 ?>
	  <td><input type="text" name="rnight" value="<?php echo $dateDiff; ?>" readonly style="background-color:#FFF59B;width:50px" num=1 class="m-ctrl" onchange="Numberofnights(This.Value)" id="nig"></td>
...
const idproofselect =document.getElementById("IDPROOFSELECT");
const idproofnumber = document.getElementById("proofnumber");
