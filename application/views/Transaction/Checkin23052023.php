...
<?php
  ...
  {  $DateofAudit=$row['DateofAudit'];}
   while ($Indate <= $todate) 
		...
		where RM.Room_Id ='".$Roomid."' Order by PT.PlanType_Id";
...
<table class="FrmTable T-6" style="margin-top:5px">
  <tr>
	...
	{ $dateDiff ='1';}
	 ...
	 ?>
	  <td><input type="text" name="rnight" value="<?php echo $dateDiff; ?>" readonly style="background-color:#FFF59B;width:50px" num=1 class="m-ctrl" onchange="Numberofnights(This.Value)" id="rnight"></td>
...
<table class="FrmTable" style="margin-top:-25px" >
  <tr>
	...
	<td  style="padding-right:30px;"><a id="CheckIn" onclick="CheckIn()"  name="CheckIn" style="display:inline-block;float:right;" class="btn btn-warning btn-sm" ><i class="fa fa-calendar-o" aria-hidden="true"></i> Check-In </a></td>
  </tr>
</table>
