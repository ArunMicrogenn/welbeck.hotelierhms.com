...
<table class="FrmTable T-6" style="margin-top:5px">
  <tr>
    ...
    <td><input type="date" name="Indate" id="Indate" value="<?php echo date('Y-m-d' , strtotime($Indate)); ?>"  class="m-ctrl" style="background-color:#FFF59B;width:100px" ></td>
    <td>Hr</td>
	...
	<td><input type="date" name="outdate" id="outdate"  value="<?php echo date('Y-m-d' , strtotime($todate)); ?>" style="background-color:#FFF59B;width:100px"  class="m-ctrl" ></td>	  
	<td>Hr</td>
...
<table class="FrmTable" style="margin-top:-15px">
  ...
  <tr>
   <td><select name="RoomNo" id="RoomNo" class="m-ctrl" >
    <?php   
...
<table class="FrmTable" style="margin-top:-25px" >
  <tr>
    ...
    <td><a id="Reserve" onclick="Reserve()"  name="Reserve" class="btn btn-warning btn-sm" ><i class="fa fa-book" aria-hidden="true"></i> Save </a></td>
    <td></td>
  </tr>
</table>
...
$("#City").autocomplete({
	...
	var ResDetid=<?php echo $ResDetid; ?>;
